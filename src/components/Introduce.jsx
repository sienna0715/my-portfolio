  ...
  return (
    <IntroWrap>
      <IntroContainar>
        ...
        <RightBox>
          개발에 흥미를 느껴 시작한 이후부터, 무엇을 잘 할 수 있는 개발자인지를
          끊임없이 고민하며 성장하고 있습니다. <br />
          <br />
          물론 신입 개발자가 이 정답을 찾기란 쉽지 않을 것입니다. 그러나
          프론트엔드 개발자로서 단단하게 성장하고 싶다는 확신으로 자바스크립에서
          시작하여 리액트, 타입스크립트를 공부하였고, 나의 분야를 더 잘 하기 위해
          고민을 하다 보니 내가 알고 있는 프로그래밍 언어를 더욱더 활용적으로
          사용하면서 애플리케이션의 전반적인 작동을 조금이나마 이해할 수 있을 것
          같아 Node.js를 공부하고 있습니다. <br />
          <br />
