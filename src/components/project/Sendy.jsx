      ...
      <S.Container>
        ...
        <S.Section>
          ...
          <S.RightBox>
            ...
            <S.Text>
              수신함에서는 보낸 사람의 이름을, 발심함에서는 편지를 받을
              사람의 이름으로 편지를 검색할 수 있도록 필터링을 구현하였고, 기간 필터, 최신순, 오랜된 순 필터를
              유저가 사용했을 때 필터된 데이터가 유지될 수 있도록 구현하는 과정에서 올바르게 로직을 작성하는 것이 쉽지 않았습니다.
              그러나 리액트 hook의 특성, 여러 문서를 통해 구현을 성공하였습니다.
              서버와의 통신으로 편지 삭제 로직도 구현을 마쳤습니다.
            </S.Text>
            <S.ImgBox>
              <S.Img
            ...
            <S.Text>
              좀 더 간편하고 관리하기가 쉬운 유효성 검사
              로직을 구현하고 싶어 yup과 react hook form을 이용하여 비밀번호 변경 페이지를
              제작하였습니다.
            </S.Text>
            <S.ImgBox>
              <S.SmallImg
